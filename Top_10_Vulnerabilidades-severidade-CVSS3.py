    ...
    if response.status_code == 200:
        ...
        for vulnerability in data["vulnerabilities"]:
            ...
            if severity == 4:  # Filtro para identificar qual severidade deseja listar
                ...
                # Verifica se a chave 'cvss3_base_score' está presente antes de acessá-la
                cvss3_base_score = vulnerability.get('cvss3_base_score', None)
                
                if cvss3_base_score is not None and cvss3_base_score >= 10: # Filtro para identificar qual score deseja listar
        ...
        for idx, vulnerability in enumerate(sorted_vulnerabilities[:10], 1):
            ...
            print(f"   CVSS3 Base Score: {vulnerability.get('cvss3_base_score', 'N/A')}")
